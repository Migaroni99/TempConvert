...
def validate_temperature_input(text):
    # This function is called whenever the user types something in the entry box.
    # It returns True if the input is valid (only numbers) or False otherwise.
...
def convert_temperature():
    try:
        ...
        unit = unit_combobox.get().lower()  # Convert input to lowercase
